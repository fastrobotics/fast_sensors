...
sensor_msgs::NavSatFix GPSHatNodeProcess::convertGPS(
    NavXIMUDriver::NavXIMUDriverContainer hat_output) {
...
nav_msgs::Odometry GPSHatNodeProcess::convertPose(
    NavXIMUDriver::NavXIMUDriverContainer hat_output) {
